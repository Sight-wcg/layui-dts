declare namespace Layui {
  ...
  interface TreeTableTreeOptionAsync {
     ...
     * @since 2.8.4
     */
    format?(trData: object, options: Required<TreeTableOption>, callback: (nodeList: Array<object>) => void): void;
  }
  ...
  interface TreeTableTreeOptionCustomName {
    ...
    /**
     * 设置根节点的 pid 属性值
     * @deprecated 2.8.2 已移除，请使用 {@link TreeTableTreeOptionData.rootPid|TreeTableTreeOptionData.rootPid}
     * @see {@link TreeTableTreeOptionData.rootPid|TreeTableTreeOptionData.rootPid}
     */
    rootId?: string;
  }
  ...
  interface TreeTable extends Omit<Table, 'setRowChecked'> {
     ...
     * @since 2.8.0
     */
    removeNode(id: string, index: string | object): void;
    /**
     * 新增行记录
     * @param id treeTable 渲染时的 id 属性值
     * @param opts 选项
     ...
     * @param id treeTable 渲染时的 id 属性值
     * @param filter 过滤函数
     * @param opts isSingle是否只找到第一个;parentNode在指定在某个父节点下的子节点中搜索
     * @since 2.8.4
     */
